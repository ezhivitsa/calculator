...
// const PRIORITY_ACTIONS = [MathOperation.Multiply, MathOperation.Divide];
...
//   private _addActionForBinaryExpression(currentExpression: BinaryExpression, action: MathOperation): void {
...
//   private _addActionForSingleExpression(currentExpression: SingleExpression, action: MathOperation): void {
...
//     this._addActionForBinaryExpression(currentExpression, MathOperation.Multiply);
...
//     this._addActionForSingleExpression(currentExpression, MathOperation.Multiply);
//     this._addPrefixModifierForBinaryExpression(this._expression as BinaryExpression, modifier);
//   }
...
//     if (!operation) {
//       currentExpression.operation = MathOperation.Multiply;
//       currentExpression.right = expression;
//       this._expression = expression;
//       return;
//     }
